...
@Component({
    selector: 'app-server-side-multi-form-field',
    templateUrl: './server-side-mult-form-field.component.html',
    styleUrls: ['./server-side-mult-form-field.component.scss'],
    providers: [
      {
        provide: NG_VALUE_ACCESSOR,
        multi:true,
        useExisting: ServerSideMultFormFieldComponent
      }
    ],
  changeDetection: ChangeDetectionStrategy.OnPush

})
export class ServerSideMultFormFieldComponent implements OnInit, OnDestroy, ControlValueAccessor {
